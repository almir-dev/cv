...
export function AdvanceInfo() {
    return <div className={styles.advancedInfo}>
        <p>
            Passionate software engineer with 5+ of experience in developing web applications focused on
            supporting clients in the Automotive industry.
        </p>
...
export function DccsExperience() {
    ...
    return <DescriptionItem title={title} description={description} timespan={timespan}>
        <p>
